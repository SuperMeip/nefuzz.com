...
/**
 * Class Map
 * The controller for the map page
 * 
...
class Map extends \Nefuzz\Controllers\Base_Controller {
  ...
  /**
   * Get the icons of all listed users
   * 
   * @param $user_list - A list of users to get Icons for
   * 
   * @return string    - An html snippet for displaying the icons
   */
