...
/**
 * Class Make_Meet
 * Controller for the meet creation page
 *
...
class Make_Meet extends \Nefuzz\Controllers\Base_Controller {
  ...
  /**
   * Attempts to use the entered info to submit a new meet to the DB
   *
   * @param array $data - The form data submitted
   *
   * @return string|bool - Returns an error message if failed, true if success
   */
