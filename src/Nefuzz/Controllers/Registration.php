...
use \Nefuzz\Models\User;

/**
 * Class Registration
 * Controller for the new user registration page
 *
...
class Registration extends \Nefuzz\Controllers\Base_Controller {
  ...
  /**
   * Check to see if the user with that name exists
   *
  ...
  /**
   * Add a new user to the site based off the form data
   *
   * @param $data - The submitted form data
   *
   * @return int|string - if successful return the new user's ID if unsuccessful return the error message
   */
