 ...
 */
class Old_User extends \Nefuzz\Models\Base_Model {
   ...
   * 
   * @param array $user_info       - [$DBColumn=>int|bool|string] - array containing the basic info from the user table in the DB
   * @param array $meet_info       - array containing the IDs of the meets this user is a host of.
   * @param array $event_info      - assoc[$event_id=>attendee_type(string)] - an array of the user's involvement in events.
   * @param array $contact_info    - assoc[contact_method=>contact_info(string)] - an array of contact_methods, the method is the key.
   * @param Location $location_obj - assoc[$LocationPart=>string] - the array used to create a Location object.
   * @param array $group_info      - assoc[group_id=>role(string)] - an array of the roles this member has in groups, the group IDs being the keys
   * @param Em_Info $emergency_obj - assoc[$DBColumn=>string|bool] - an array of emergency info from the database used to create an Em_Info object.
   */
 ...
 /*///////////////////////////////////////////////////////////////////////*/
  ...
  /**
   * Set Sub-Functions
   *    Each is used to save a part of the user info to the DB
   */
   ...
   *
   * @param string $username - The user to get the id of
   * 
  ...
  /**
   * Gets the icon of the given user by name
   *
   * @param string $username - user to get the icon of
   *
   * @return string - the url of the icon
   */
  public static function get_icon_by_username($username) {
    $DB = new DBC();
    $query = "
      SELECT 
        has_icon,
  ...
  /**
   * Gets the page link by username
   *
   * @param $username - username to get the page link of
   *
   * @return string - the link to the user's page
   */
  public static function get_page_link_from_username($username) {
   ...
   * 
   * @return string - a json containing all of the info from this user, this is able to be made into a User object via user::deserialize()
   */
  public function serialize() {
    ...
    $raw["location_info"] = $copy->location->serialize();
    $copy->location = null;
